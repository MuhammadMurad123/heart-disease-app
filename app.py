...
st.markdown("""
    ...
    div[data-testid="stMetric"] { background-color: white; padding: 15px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }
    </style>
...
if lang == "Urdu":
    ...
    labels = {"age": "👴 عمر (سال)", "bp": "🩸 بلڈ پریشر (mmHg)", "chol": "🧪 کولیسٹرول (mg/dl)", "mhr": "💓 دل کی دھڑکن", "eia": "⚠️ ورزش پر سینے میں درد"}
    ...
    labels = {"age": "👴 Age (Years)", "bp": "🩸 Blood Pressure (mmHg)", "chol": "🧪 Cholesterol (mg/dl)", "mhr": "💓 Max Heart Rate", "eia": "⚠️ Exercise Induced Angina?"}
